...
class createRouteTransition: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    internal func animateTransition(transitionContext: UIViewControllerContextTransitioning) {
        ...
        let toVC = transitionContext.viewControllerForKey(UITransitionContextToViewControllerKey) as! createRouteView
