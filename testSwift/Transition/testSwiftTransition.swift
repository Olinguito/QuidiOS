...
class testSwiftTransition: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    internal func animateTransition(transitionContext: UIViewControllerContextTransitioning) {
        ...
        let toVC = transitionContext.viewControllerForKey(UITransitionContextToViewControllerKey) as! testSwiftView
        
        toVC.transitioningBackgroundView.backgroundColor = UIColor.redColor()
